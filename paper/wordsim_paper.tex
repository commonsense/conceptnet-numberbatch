...
\bf G  &GloVe 42B    & $L_2$ & ---       & ---      &     .489 &     .813 &      .759 &      .595 &     .829 &     .836 \\
...
\bf WL1&GloVe 840B   & $L_1$ & CN5.4     & CN5.4    &     .587 &{\bf .858}& {\bf .818}&      .668 &{\bf .852}&{\bf .845}\\
\bf WL2&GloVe 840B   & $L_1$ & CN5.4     & Both     &{\bf .591}&{\bf .858}&      .817 &      .671 &     .846 &     .842 \\
\bottomrule
\end{tabular}
...
\caption{
    ...
    The row labeled {\bf L} shows results from \newcite{levy2015embeddings}, the previous state of the art on the RW evaluation.
...
\caption{
    ...
    ``ConceptNet 4'' represents a combination of ported sources that are
    difficult to separate: Open Mind Common Sense, GlobalMind, and nadya.jp.
}
...
MEN-3000 comes with a training/test split, where 1000 of the 3000 word pairs
...
Table~\ref{eval-bigtable} shows our correlation with the development
