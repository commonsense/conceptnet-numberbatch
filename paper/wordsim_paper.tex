...
\item a parsed version Wiktionary entries whose target language is English or
      German \cite{wiktionary2014en} \cite{wiktionary2014de}, and generated by a
      parser, developed as part of the ConceptNet 5 codebase
...
which is the union of the vocabularies the embedding and the lexicon. Let $S$ be
...
840B-token dataset, we found an unexpected benefit from cleaned up that data in
