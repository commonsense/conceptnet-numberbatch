...
better input to further machine learning than uncorrelated ``one-hot'' vectors.
...
ensemble method that combines embeddings from GloVe \cite{pennington2014glove}
