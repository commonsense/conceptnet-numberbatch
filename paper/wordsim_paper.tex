...
It seems that 1-norms are the most effective at emphasizing useful features
in this task: our tests show that $L_1$ normalization provides a consisent
performance increase over $L_2$ normalization in almost all variations of
GloVe.
...
\toprule
% TODO: introduce MEN-3000 [all] as a column
