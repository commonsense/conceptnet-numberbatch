...
which we have found leads to better similarity measurements than the L2
...
also ``GloVe 840B'' calculated from 840 billion tokens, which can perform
better, but their term labels require some data cleaning first. We will do this
cleaning as part of the ensemble method.
