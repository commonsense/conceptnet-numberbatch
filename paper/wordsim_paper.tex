...
Label  &Embeddings   & Labels        & Norm  & Network &       RW &      MEN &        WS &      SCWS &    RG-65 &    MC-30 \\
\midrule
       & word2vec    & Original      & ---   & ---     &    .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Original      & $L_2$ & ---     &    .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Original      & $L_1$ & ---     &    .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Standardized  & ---   & ---     &    .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Standardized  & $L_2$ & ---     &    .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Standardized  & $L_1$ & ---     &    .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
\midrule
       &GloVe 42B    & Original      & ---   & ---     &    .348 &     .740 &      .632 &      .440 &     .817 &     .777 \\
\bf G  &GloVe 42B    & Original      & $L_2$ & ---     &    .448 &     .816 &      .759 &      .595 &     .829 &     .836 \\
       &GloVe 42B    & Original      & $L_1$ & ---     &    .457 &     .820 &      .766 &      .606 &     .826 &     .829 \\
       &GloVe 42B    & Standardized  & ---   & ---     &    .366 &     .760 &      .646 &      .444 &     .810 &     .762 \\
       &GloVe 42B    & Standardized  & $L_2$ & ---     &    .490 &     .815 &      .765 &      .587 &     .779 &     .815 \\
       &GloVe 42B    & Standardized  & $L_1$ & ---     &    .513 &     .834 &      .794 &      .619 &     .814 &     .828 \\
\midrule
       &GloVe 840B   & Original      & ---   & ---     &    .070 &     .728 &      .627 &      .441 &     .648 &     .696 \\
       &GloVe 840B   & Original      & $L_2$ & ---     &    .089 &     .768 &      .664 &      .496 &     .652 &     .666 \\
       &GloVe 840B   & Original      & $L_1$ & ---     &    .091 &     .772 &      .667 &      .500 &     .653 &     .682 \\
       &GloVe 840B   & Standardized  & ---   & ---     &    .434 &     .803 &      .735 &      .552 &     .775 &     .787 \\
       &GloVe 840B   & Standardized  & $L_2$ & ---     &    .493 &     .811 &      .760 &      .564 &     .717 &     .789 \\
\bf LE0&GloVe 840B   & Standardized  & $L_1$ & ---     &    .512 &     .840 &      .798 &      .615 &     .774 &     .798 \\
\midrule
       & word2vec    & Standardized  & $L_1$ & PPDB    &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Standardized  & $L_1$ & CN5.4   &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & word2vec    & Standardized  & $L_1$ & Both    &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
\midrule
       &GloVe 840B   & Standardized  & $L_1$ & PPDB    &     .560 &     .852 &      .806 & {\bf .674}&     .821 &     .824 \\
\bf LE1&GloVe 840B   & Standardized  & $L_1$ & CN5.4   &     .581 &{\bf .860}& {\bf .818}&      .668 &{\bf .852}&{\bf .845}\\
\bf LE2&GloVe 840B   & Standardized  & $L_1$ & Both    &{\bf .584}&{\bf .860}&      .817 &      .671 &     .846 &     .842 \\
\midrule
       & 840B + word2vec & Standardized  & $L_1$ & ---     &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & 840B + word2vec & Standardized  & $L_1$ & PPDB    &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & 840B + word2vec & Standardized  & $L_1$ & CN5.4   &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
       & 840B + word2vec & Standardized  & $L_1$ & Both    &     .??? &     .??? &      .??? &      .??? &     .??? &     .??? \\
\bottomrule
\end{tabular}
\end{small}
...
\caption{
    ...
    ``Norm'' indicates the norm applied to the columns of GloVe. ``Labels''
    indicates whether we used the original labels or standardized them.
    ``Retrofit'' indicates which data is added using expanded
    retrofitting.
    Labels indicate interesting configurations that we will discuss further.
}
\label{eval-bigtable}
\end{table*}
...
have been translated into Spanish by \newcite{hassan2009crosslingual}, and
RG-65 has been translated into German by \newcite{gurevych2005german} and
