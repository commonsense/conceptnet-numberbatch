...
increasing effective approach for semantic analysis. In this paper, we show the
...
ConceptNet 5 \cite{speer2012conceptnet}, taking care to merge them into a common
word representation. The resulting vector space has a larger vocabulary than
either source, can represent the meaning of a word in multiple languages, and
