...
\caption{
    ...
    although this is using the entire set and not our held-out test set.
...
\caption{
    ...
    ``ConceptNet 4'' represents data from Open Mind Common Sense and
    GlobalMind. RW and MEN-3000 were evaluated on the development set here,
