...
\cite{pennington2014glove} and word2vec \cite{mikolov2013word2vec}
with structured knowledge from the semantic network ConceptNet 5
...
The ensemble method we present here combines these and adds a few more
ingredients:

\begin{itemize}
\item We use ConceptNet, a Linked Open Data semantic network that expresses many
kinds of relationships between words in many languages, as the source of
...
which we have found leads to better simliarity measurements than the L2
normalization that is standard for GloVe.
\end{itemize}

This process achieves state-of-the-art performance on word-similarity
...
The ``GloVe 840B''
embeddings, calculated from 840 billion tokens of the Common Crawl, contain
valuable data but require some cleaning of their text labels before they will
perform well. We will do this cleaning as part of the ensemble method.
...
% TODO: generalize this section, describing the flow of vocabulary
