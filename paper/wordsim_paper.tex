...
connections between words. The combined embedding achieving performance on word-similarity evaluations superior to either source individually.

%TODO Move to GloVe section
%We have expanded the retrofitting technique to operate on the union of two
%vocabularies, rather than the intersection.

By combining a modified version of this technique with some subtle but important
...
show that each of these methods improve performance on word-similarity evaluations, even when applied separately, and that the best results comes from applying all of them at once:
