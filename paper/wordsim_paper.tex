...
The MEN data is never used as an input to the system; we did not use or even
look at the held-out data when setting parameters; and the same system that
performs above the claimed upper bound of MEN also performs the highest on all
the other data sets we tried.
